...
class GameState
{
  ...
  function getStateNumberByTransition($transition)
  {
    ...
    throw new BgaUserException("This transition ($transition) is impossible at this state ($this->current_state)");
  }
...
class BgaUserException extends BgaUserException
{
...
class BgaSystemException extends BgaUserException
{
  public function __construct($message, $code = 100)
  {
...
abstract class Table extends APP_GameClass
{
  ...
  function getGameinfos()
  {
    ...
    throw new BgaUserException("gameinfos.inp.php suppose to define \$gameinfos variable");
  }
