...
var StaticDataSprites = /** @class */ (function () {
    ...
    StaticDataSprites.spritesheetMetadata = {
...
var GameBody = /** @class */ (function (_super) {
    ...
    GameBody.prototype.rescaleSprite = function (el, scale) {
        ...
        var bgSize = spritesheetMetadata.totalWidth * scale +
            'px ' +
            spritesheetMetadata.totalHeight * scale +
            'px';
        el.style.backgroundSize = bgSize;
        el.style.maskSize = bgSize;
        var spritesheetPos = spriteMetadata.offsetX * scale +
            'px ' +
